/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6887f4bd325f53b220614802f89b3266)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		EMAIL: SendEmail;
		WEBHOOK_QUEUE: Queue;
		APP_URL: "https://cfmail.eckoln.workers.dev";
		POLICY_AUD: string;
		TEAM_DOMAIN: string;
		DATABASE_URL: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "POLICY_AUD" | "TEAM_DOMAIN" | "DATABASE_URL">> {}
}
